	...
	{:else if poste}
		<header class="entete">
			...
			<div class="titre-ligne">
				<h1>{poste.titre}</h1>
				{#if estAdmin}
					<button class="bouton-modifier" onclick={() => goto(`/lieux/${lieuId}/postes/${posteId}/modifier`)} aria-label="Modifier le poste">
...
<style>
	...
	.bouton-modifier {
		...
		color: var(--couleur-primaire); padding: var(--esp-xs) var(--esp-sm);
		border: 1.5px solid var(--couleur-primaire); border-radius: var(--rayon-md);
